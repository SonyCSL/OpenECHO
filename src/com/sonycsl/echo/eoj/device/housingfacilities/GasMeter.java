...
public abstract class GasMeter extends DeviceObject {
	...
	private static final String TAG = GasMeter.class.getSimpleName();
	...
	/**
	 * This property indicates integral gas consumption in units of 0.001 m3.<br>0x0.0x3B9AC9FF (0.999999,999m3)
	 */
	protected abstract byte[] getIntegralGasConsumptionMeasurementValue();
	/**
	 * This property indicates integral gas consumption measurement result log for past 24 hours as data in 30-minute segments.<br>0x0.0x3B9AC9FF (0.999999,999m3)
	 */
