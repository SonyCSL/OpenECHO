...
public class SmartGasMeterProxy extends SmartGasMeter {
	@SuppressWarnings("unused")
	private static final String TAG = SmartGasMeterProxy.class.getSimpleName();
	...
	public static class Receiver extends SmartGasMeter.Receiver {
	}
}
