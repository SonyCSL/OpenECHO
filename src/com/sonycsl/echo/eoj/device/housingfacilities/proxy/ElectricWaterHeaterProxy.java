...
public class ElectricWaterHeaterProxy extends ElectricWaterHeater {
	@SuppressWarnings("unused")
	private static final String TAG = ElectricWaterHeaterProxy.class.getSimpleName();

	private byte mInstanceCode;
	
	public ElectricWaterHeaterProxy(byte instanceCode) {
	...
	public static class Receiver extends ElectricWaterHeater.Receiver {
	}
}
