...
public class ElectricToiletSeatProxy extends ElectricToiletSeat {
	@SuppressWarnings("unused")
	private static final String TAG = ElectricToiletSeatProxy.class.getSimpleName();
	...
	public static class Receiver extends ElectricToiletSeat.Receiver {
	}
}
