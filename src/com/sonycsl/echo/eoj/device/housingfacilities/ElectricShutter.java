...
public abstract class ElectricShutter extends DeviceObject {
	...
	/**
	 * Open(ed)/close(d)/stop(ped)<br><br>Open(ed) = 0x41, close(d) = 0x42, stop(ped) = 0x43<br><br>Name : Open/close setting 1<br>EPC : 0xE0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : mandatory<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	...
	/**
	 * Used to specify the extent of opening by selecting a level from among the 8 predefined levels, and to acquire the current setting.<br><br>0x31 to 0x38<br><br>Name : Extent of opening 1<br>EPC : 0xE1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * Blind angle<br><br>0x00 to 0xB4 (0 to 180  )<br><br>Name : Blind angle setting<br>EPC : 0xE2<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * Low/medium/high<br><br>Low = 0x41, medium = 0x42, high = 0x43<br><br>Name : Shutter speed<br>EPC : 0xE3<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * Used to specify the extent of opening by selecting a level from among the 256 predefined levels, and to acquire the current setting.<br><br>0x00 to 0xFF (0 to 255)<br><br>Name : Extent of opening 2<br>EPC : 0xE4<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * Used to specify whether or not to activate the electric lock, and to acquire the current setting.<br><br>Activated = 0x41, deactivated = 0x42<br><br>Name : Electric lock setting<br>EPC : 0xE5<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * Open/close<br><br>Open = 0x41, close = 0x42<br><br>Name : Open/close setting 2<br>EPC : 0xE7<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : mandatory<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
