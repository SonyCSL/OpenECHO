...
public abstract class Buzzer extends DeviceObject {
	...
	private static final String TAG = Buzzer.class.getSimpleName();
	...
	/**
	 * This property indicates buzzer sound generation setting.<br>Buzzer enabled = 0x41, buzzer disabled = 0x42
	 */
	...
	/**
	 * This property indicates 8 different types of buzzer sound.<br>0x31.0x38
	 */
