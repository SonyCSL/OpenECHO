...
public abstract class GasSensor extends DeviceObject {
	...
	/**
	 * This property indicates gas detection status.<br>Gas detection status found = 0x41 Gas detection status not found = 0x42
	 */
	protected byte[] getGasDetectionStatus() {return null;}
	/**
	 * This property indicates measured value of gas concentration in ppm.<br>0x0000.0xFFFD (0.65533)
	 */
