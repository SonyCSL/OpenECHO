...
public abstract class IlluminanceSensor extends DeviceObject {
	...
	private static final String TAG = IlluminanceSensor.class.getSimpleName();
	...
	/**
	 * This property indicates measured illuminance value in lux.<br>0x0000.0xFFFD (0 to 65533 lux)
	 */
	protected abstract byte[] getMeasuredIlluminanceValue1();
	/**
	 * This property indicates measured illuminance value in kilo lux.<br>0x0000.0xFFFD (0 to 65533 klux)
	 */
