...
public abstract class AirPollutionSensor extends DeviceObject {
	...
	private static final String TAG = AirPollutionSensor.class.getSimpleName();
	
	public static final byte CLASS_GROUP_CODE = (byte)0x00;
	public static final byte CLASS_CODE = (byte)0x0B;

	protected static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	protected static final byte EPC_AIR_POLLUTION_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * This property indicates air pollution detection status.<br>Air pollution detection status found = 0x41 Air pollution detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
