...
public abstract class EarthquakeSensor extends DeviceObject {
	...
	/**
	 * This property indicates earthquake occurrence status.<br>Earthquake occurrence status found = 0x41 Earthquake occurrence status not found = 0x42
	 */
	protected abstract byte[] getEarthquakeOccurrenceStatus();
	/**
	 * Resets earthquake occurrence status by setting 0x00.<br>Reset = 0x00
	 */
