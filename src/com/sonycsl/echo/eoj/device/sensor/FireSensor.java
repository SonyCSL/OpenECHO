...
public abstract class FireSensor extends DeviceObject {
	...
	/**
	 * Specifies detection threshold level (8-step). Concrete status of each level is not specified.<br>Level 0x31.0x38
	 */
	...
	/**
	 * This property indicates fire occurrence detection status.<br>Fire occurrence detection status found = 0x41 Fire occurrence detection status not found = 0x42
	 */
	protected abstract byte[] getFireOccurrenceDetectionStatus();
	/**
	 * Resets fire occurrence detection status by setting 0x00.<br>Reset = 0x00
	 */
