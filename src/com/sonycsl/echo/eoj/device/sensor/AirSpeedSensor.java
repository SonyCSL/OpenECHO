...
public abstract class AirSpeedSensor extends DeviceObject {
	...
	/**
	 * This property indicates the measured value of air speed in units of 0.01 m/sec.<br>0x0000.0xFFFD (0.65533) (0.655.33 m/sec)
	 */
	protected abstract byte[] getMeasuredValueOfAirSpeed();
	/**
	 * This property indicates air flow direction in units of degrees.<br>0x0000-0x0168 (0-360degree)
	 */
