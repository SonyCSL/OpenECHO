...
public abstract class DifferentialPressureSensor extends DeviceObject {
	...
	private static final String TAG = DifferentialPressureSensor.class.getSimpleName();
	...
	/**
	 * This property indicates measured value of differential pressure in Pa.<br>0x8001.0x7FFE (-32767.32766)
	 */
