...
public abstract class HumanDetectionSensor extends DeviceObject {
	...
	private static final String TAG = HumanDetectionSensor.class.getSimpleName();
	
	public static final byte CLASS_GROUP_CODE = (byte)0x00;
	public static final byte CLASS_CODE = (byte)0x07;

	protected static final byte EPC_DETECTION_THRESHOLD_LEVEL = (byte)0xB0;
	protected static final byte EPC_HUMAN_DETECTION_STATUS = (byte)0xB1;
	...
	/**
	 * This property indicates human detection status.<br>Human detection status found = 0x41 Human detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
