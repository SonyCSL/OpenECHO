...
public abstract class OdorSensor extends DeviceObject {
	...
	/**
	 * Specifies detection threshold level (8-step).<br>Level 0x31.0x38
	 */
	...
	/**
	 * This property indicates odor detection status.<br>Odor detection status found = 0x41 Odor detection status not found = 0x42
	 */
	protected byte[] getOdorDetectionStatus() {return null;}
	/**
	 * This property indicates measured odor value. The unit is not specified.<br>0x00.0xFD (0.253)
	 */
