...
public abstract class MailingSensor extends DeviceObject {
	...
	protected static final byte EPC_MAILING_DETECTION_STATUS = (byte)0xB1;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_MAILING_DETECTION_STATUS:
				onGetMailingDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates mailing detection status.<br>Mailing detection status found = 0x41 Mailing detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetMailingDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetMailingDetectionStatus() {
			...
			addProperty(EPC_MAILING_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
