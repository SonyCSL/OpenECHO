...
public abstract class CrimePreventionSensor extends DeviceObject {
	...
	/**
	 * This property indicates invasion occurrence status.<br>Invasion occurrence status found = 0x41 Invasion occurrence status not found = 0x42
	 */
	protected abstract byte[] getInvasionOccurrenceStatus();
	/**
	 * Resets invasion occurrence status by setting 0x00.<br>Reset = 0x00
	 */
