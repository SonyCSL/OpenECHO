...
public abstract class WaterLevelSensor extends DeviceObject {
	...
	/**
	 * This property indicates the water level over detection threshold level in cm.<br>0x00.0xFD (0.253)
	 */
	protected byte[] getWaterLevelOverDetectionThresholdLevel() {return null;}
	/**
	 * This property indicates if the water level exceeds detected water level threshold level.<br>Water level over detection status found = 0x41 Water level over detection status not found = 0x42
	 */
	protected byte[] getWaterLevelOverDetectionStatus() {return null;}
	/**
	 * This property indicates measured value of water level in cm.<br>0x00.0xFD (0.253)
	 */
