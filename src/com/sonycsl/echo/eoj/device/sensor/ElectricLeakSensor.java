...
public abstract class ElectricLeakSensor extends DeviceObject {
	...
	protected void onReceiveSet(EchoFrame res, byte epc, byte pdc, byte[] edt) {
		...
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING:
			res.addProperty(epc, edt, setElectricLeakOccurrenceStatusResetting(edt));
			break;
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS:
			edt = getElectricLeakOccurrenceStatus();
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveSetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING:
				onSetElectricLeakOccurrenceStatusResetting(eoj, tid, (pdc != 0));
				break;
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS:
				onGetElectricLeakOccurrenceStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates leak occurrence status.<br>Electric leak occurrence status found = 0x41 Electric leak occurrence status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetElectricLeakOccurrenceStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
		/**
		 * Resets electric leak occurrence status by setting 0x00.<br>Reset = 0x00<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : optional<br>Get : undefined
		 */
		protected void onSetElectricLeakOccurrenceStatusResetting(EchoObject eoj, short tid, boolean success) {}
	...
	public class SetterImpl extends DeviceObject.SetterImpl implements Setter {
		...
		@Override
		public Setter reqSetElectricLeakOccurrenceStatusResetting(byte[] edt) {
			addProperty(EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS_RESETTING, edt, setElectricLeakOccurrenceStatusResetting(edt));
			return this;
		}
	}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetElectricLeakOccurrenceStatus() {
			...
			addProperty(EPC_ELECTRIC_LEAK_OCCURRENCE_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
