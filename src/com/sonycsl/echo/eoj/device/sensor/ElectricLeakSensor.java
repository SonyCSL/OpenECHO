...
public abstract class ElectricLeakSensor extends DeviceObject {
	...
	/**
	 * This property indicates leak occurrence status.<br>Electric leak occurrence status found = 0x41 Electric leak occurrence status not found = 0x42
	 */
	protected abstract byte[] getElectricLeakOccurrenceStatus();
	/**
	 * Resets electric leak occurrence status by setting 0x00.<br>Reset = 0x00
	 */
