...
public abstract class RainSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x13;
	...
	/**
	 * This property indicates rain detection status.<br><br>Rain detection status found = 0x41 Rain detection status not found = 0x42<br><br>Name : Rain detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getRainDetectionStatus();
	private final byte[] _getRainDetectionStatus(byte epc) {
		byte[] edt = getRainDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_RAIN_DETECTION_STATUS:
			edt = _getRainDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_RAIN_DETECTION_STATUS:
				_onGetRainDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates rain detection status.<br><br>Rain detection status found = 0x41 Rain detection status not found = 0x42<br><br>Name : Rain detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetRainDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetRainDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetRainDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetRainDetectionStatus() {
			addProperty(EPC_RAIN_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformRainDetectionStatus() {
			byte epc = EPC_RAIN_DETECTION_STATUS;
			byte[] edt = _getRainDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
