...
public abstract class RainSensor extends DeviceObject {
	...
	protected static final byte EPC_RAIN_DETECTION_STATUS = (byte)0xB1;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_RAIN_DETECTION_STATUS:
				onGetRainDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates rain detection status.<br>Rain detection status found = 0x41 Rain detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetRainDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetRainDetectionStatus() {
			...
			addProperty(EPC_RAIN_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
