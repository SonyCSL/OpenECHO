...
public abstract class RainSensor extends DeviceObject {
	...
	private static final String TAG = RainSensor.class.getSimpleName();
	...
	/**
	 * This property indicates rain detection status.<br>Rain detection status found = 0x41 Rain detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
