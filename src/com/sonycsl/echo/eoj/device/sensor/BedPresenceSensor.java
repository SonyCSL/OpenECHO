...
public abstract class BedPresenceSensor extends DeviceObject {
	...
	/**
	 * Specifies detection threshold level (8-step).<br>Detection threshold level 0x31.0x38
	 */
	...
	/**
	 * This property indicates bed presence detection status.<br>Bed presence detected = 0x41, Bed presence not detected = 0x42
	 */
