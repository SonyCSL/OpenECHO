...
public abstract class BedPresenceSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x28;
	...
	/**
	 * This property indicates bed presence detection status.<br><br>Bed presence detected = 0x41, Bed presence not detected = 0x42<br><br>Name : Bed presence detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getBedPresenceDetectionStatus();
	private final byte[] _getBedPresenceDetectionStatus(byte epc) {
		byte[] edt = getBedPresenceDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_BED_PRESENCE_DETECTION_STATUS:
			edt = _getBedPresenceDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_BED_PRESENCE_DETECTION_STATUS:
				_onGetBedPresenceDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates bed presence detection status.<br><br>Bed presence detected = 0x41, Bed presence not detected = 0x42<br><br>Name : Bed presence detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetBedPresenceDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetBedPresenceDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetBedPresenceDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetBedPresenceDetectionStatus() {
			addProperty(EPC_BED_PRESENCE_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformBedPresenceDetectionStatus() {
			byte epc = EPC_BED_PRESENCE_DETECTION_STATUS;
			byte[] edt = _getBedPresenceDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
