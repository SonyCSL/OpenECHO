...
public abstract class BedPresenceSensor extends DeviceObject {
	...
	protected static final byte EPC_BED_PRESENCE_DETECTION_STATUS = (byte)0xB1;
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_BED_PRESENCE_DETECTION_STATUS:
			edt = getBedPresenceDetectionStatus();
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_BED_PRESENCE_DETECTION_STATUS:
				onGetBedPresenceDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates bed presence detection status.<br>Bed presence detected = 0x41, Bed presence not detected = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetBedPresenceDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetBedPresenceDetectionStatus() {
			...
			addProperty(EPC_BED_PRESENCE_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
