...
public abstract class SoundSensor extends DeviceObject {
	...
	/**
	 * This property indicates sound detection status.<br>Sound detection status found = 0x41 Sound detection status not found = 0x42
	 */
	protected abstract byte[] getSoundDetectionStatus();
	/**
	 * This property indicates sound detection holding time in units of 10 seconds.<br>0x0000.0xFFFD (0 sec. to 655.330 sec.)
	 */
