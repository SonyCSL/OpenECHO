...
public abstract class WaterFlowRateSensor extends DeviceObject {
	...
	/**
	 * This property indicates measured integral flow in cm3.<br>0x00000000.0x3B9AC9FF (0.999,999,999)
	 */
	protected byte[] getIntegralFlowRate() {return null;}
	/**
	 * This property indicates measured instantaneous flow rate in cm3/mm.<br>0x0000.0x3B9AC9FF (0.999,999,999)
	 */
