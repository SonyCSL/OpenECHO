...
public abstract class BathWaterLevelSensor extends DeviceObject {
	...
	private static final String TAG = BathWaterLevelSensor.class.getSimpleName();
	...
	/**
	 * This property indicates the bath water level over detection threshold level in cm.<br>0x00.0xFD (0.253)
	 */
	protected byte[] getBathWaterLevelOverDetectionThresholdLevel() {return null;}
	/**
	 * This property indicates if bath water level exceeds detection water level threshold level.<br>Water level over detection status found = 0x41 Water level over detection status not found = 0x42
	 */
	protected byte[] getBathWaterLevelOverDetectionStatus() {return null;}
	/**
	 * This property indicates measured value of bath water level in cm.<br>0x00.(0xFD) (0.253)
	 */
