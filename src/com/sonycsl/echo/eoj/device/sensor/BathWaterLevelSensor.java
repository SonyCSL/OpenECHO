...
public abstract class BathWaterLevelSensor extends DeviceObject {
	...
	/**
	 * This property indicates the bath water level over detection threshold level in cm.<br><br>0x00.0xFD (0.253)<br><br>Name : Bath water level over detection threshold level<br>EPC : 0xB0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : optional<br>
	 */
	...
	/**
	 * This property indicates if bath water level exceeds detection water level threshold level.<br><br>Water level over detection status found = 0x41 Water level over detection status not found = 0x42<br><br>Name : Bath water level over detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : optional<br><br>Announcement at status change<br>
	 */
	...
	/**
	 * This property indicates measured value of bath water level in cm.<br><br>0x00.(0xFD) (0.253)<br><br>Name : Measured value of bath water level<br>EPC : 0xE0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br>
	 */
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetBathWaterLevelOverDetectionThresholdLevel() {
			addProperty(EPC_BATH_WATER_LEVEL_OVER_DETECTION_THRESHOLD_LEVEL);
			return this;
		}
		/**
		 * This property indicates if bath water level exceeds detection water level threshold level.<br><br>Water level over detection status found = 0x41 Water level over detection status not found = 0x42<br><br>Name : Bath water level over detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : optional<br><br>Announcement at status change<br>
		...
		public Getter reqGetBathWaterLevelOverDetectionStatus() {
			addProperty(EPC_BATH_WATER_LEVEL_OVER_DETECTION_STATUS);
			return this;
		}
		/**
		 * This property indicates measured value of bath water level in cm.<br><br>0x00.(0xFD) (0.253)<br><br>Name : Measured value of bath water level<br>EPC : 0xE0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br>
		...
		public Getter reqGetMeasuredValueOfBathWaterLevel() {
			addProperty(EPC_MEASURED_VALUE_OF_BATH_WATER_LEVEL);
			return this;
		}
	}
