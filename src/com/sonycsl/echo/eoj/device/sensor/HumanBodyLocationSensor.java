...
public abstract class HumanBodyLocationSensor extends DeviceObject {
	...
	/**
	 * This property indicates human body detection location. The array element number indicates a human body ID.<br>1st byte: X coordinate; 2nd byte: Y coordinate; 3rd byte: Z coordinate
	 */
	protected abstract byte[] getHumanBodyDetectionLocation1();
	/**
	 * This property indicates maximum number of human body IDs that can be registered for human body detection location 1.<br>0x0001.0x0080 (= 1.128)
	 */
	protected byte[] getMaximumNumberOfHumanBodyIdFs() {return null;}
	/**
	 * This property indicates human body detection location.<br>1st byte: X coordinate; 2nd byte: Y coordinate; 3rd byte: Z coordinate
	 */
	protected abstract byte[] getHumanBodyDetectionLocation2();
	/**
	 * Array element number information retained by human body detection location 1.<br>(See (5) below for details.)
	 */
