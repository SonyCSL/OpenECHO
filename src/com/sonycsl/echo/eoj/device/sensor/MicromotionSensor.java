...
public abstract class MicromotionSensor extends DeviceObject {
	...
	/**
	 * This property indicates whether micromotion is detected or not.<br>Micromotion detected = 0x41 Micromotion not detected = 0x42
	 */
	protected abstract byte[] getMicromotionDetectionStatus();
	/**
	 * This property indicates micromotion detection count.<br>0x0000.0xFFFE (0.65534)
	 */
	...
	/**
	 * This property indicates micromotion detection sampling count.<br>0x0000.0xFFFE (0.65534)
	 */
	...
	/**
	 * This property indicates micromotion detection sampling cycle.<br>0x0000.0xFFFE (0.65534)
	 */
