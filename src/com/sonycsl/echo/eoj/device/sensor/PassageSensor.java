...
public abstract class PassageSensor extends DeviceObject {
	...
	private static final String TAG = PassageSensor.class.getSimpleName();
	...
	/**
	 * This property indicates passage detection hold time in ms.<br>0x0000.0xFFFD (0.65533 ms)
	 */
	...
	/**
	 * This property indicates direction of passage (one of 8 different directions).<br>0x30: No passage. 0x31 to 0x38: Direction of passage. 0x39: Passage detected but not located. Or, a sensor incapable of detecting passage direction was passed.
	 */
