...
public abstract class CigaretteSmokeSensor extends DeviceObject {
	...
	private static final String TAG = CigaretteSmokeSensor.class.getSimpleName();
	...
	/**
	 * This property indicates smoke (cigarette) detection status.<br>Smoke (cigarette) detection status found = 0x41 Smoke (cigarette) detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
