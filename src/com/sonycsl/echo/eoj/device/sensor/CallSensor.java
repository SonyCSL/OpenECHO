...
public abstract class CallSensor extends DeviceObject {
	...
	/**
	 * This property indicates call status.<br>Call status found = 0x41 Call status not found = 0x42
	 */
	protected abstract byte[] getCallStatus();
	/**
	 * This property indicates the call holding time in units of 10 seconds.<br>0x0000.0xFFFD (0 sec. to 655,300 sec.)
	 */
