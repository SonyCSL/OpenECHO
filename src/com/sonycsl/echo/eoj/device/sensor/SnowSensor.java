...
public abstract class SnowSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x2C;
	...
	/**
	 * This    property    indicates    threshold levels with 8 steps<br><br>0x31-0x38<br><br>Name : Detection threshold level<br>EPC : 0xB0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 Byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * This property indicates snow detection<br><br>detected 0x41, not detected 0x42<br><br>Name : Snow detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 Byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getSnowDetectionStatus();
	private final byte[] _getSnowDetectionStatus(byte epc) {
		byte[] edt = getSnowDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_SNOW_DETECTION_STATUS:
			edt = _getSnowDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_SNOW_DETECTION_STATUS:
				_onGetSnowDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates snow detection<br><br>detected 0x41, not detected 0x42<br><br>Name : Snow detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 Byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetSnowDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetSnowDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetSnowDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetSnowDetectionStatus() {
			addProperty(EPC_SNOW_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformSnowDetectionStatus() {
			byte epc = EPC_SNOW_DETECTION_STATUS;
			byte[] edt = _getSnowDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
