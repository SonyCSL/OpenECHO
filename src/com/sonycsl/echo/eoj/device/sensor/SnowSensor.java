...
public abstract class SnowSensor extends DeviceObject {
	...
	protected static final byte EPC_SNOW_DETECTION_STATUS = (byte)0xB1;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_SNOW_DETECTION_STATUS:
				onGetSnowDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates snow detection<br>detected 0x41, not detected 0x42<br><br>Data type : unsigned char<br>Data size : 1 Byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetSnowDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetSnowDetectionStatus() {
			...
			addProperty(EPC_SNOW_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
