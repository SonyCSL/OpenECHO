...
public abstract class BathHeatingStatusSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x16;
	...
	/**
	 * Specifies detection threshold level (8-step).<br><br>Level 0x31 to 0x38<br><br>Name : Detection threshold level<br>EPC : 0xB0<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : optional<br>
	 */
	...
	/**
	 * This property indicates bath heating detection status.<br><br>Bath heating detection status found = 0x41 Bath heating detection status not found = 0x42<br><br>Name : Bath heating detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getBathHeatingDetectionStatus();
	private final byte[] _getBathHeatingDetectionStatus(byte epc) {
		byte[] edt = getBathHeatingDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_BATH_HEATING_DETECTION_STATUS:
			edt = _getBathHeatingDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_BATH_HEATING_DETECTION_STATUS:
				_onGetBathHeatingDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates bath heating detection status.<br><br>Bath heating detection status found = 0x41 Bath heating detection status not found = 0x42<br><br>Name : Bath heating detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetBathHeatingDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetBathHeatingDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetBathHeatingDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetBathHeatingDetectionStatus() {
			addProperty(EPC_BATH_HEATING_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformBathHeatingDetectionStatus() {
			byte epc = EPC_BATH_HEATING_DETECTION_STATUS;
			byte[] edt = _getBathHeatingDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
