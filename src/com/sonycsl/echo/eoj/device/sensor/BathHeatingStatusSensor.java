...
public abstract class BathHeatingStatusSensor extends DeviceObject {
	...
	/**
	 * Specifies detection threshold level (8-step).<br>Level 0x31 to 0x38
	 */
	...
	/**
	 * This property indicates bath heating detection status.<br>Bath heating detection status found = 0x41 Bath heating detection status not found = 0x42
	 */
