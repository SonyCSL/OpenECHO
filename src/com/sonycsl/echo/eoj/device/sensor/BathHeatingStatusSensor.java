...
public abstract class BathHeatingStatusSensor extends DeviceObject {
	...
	private static final String TAG = BathHeatingStatusSensor.class.getSimpleName();
	...
	/**
	 * Specifies detection threshold level (8-step).<br>Level 0x31 to 0x38<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : optional<br>Get : optional
	 */
	...
	/**
	 * This property indicates bath heating detection status.<br>Bath heating detection status found = 0x41 Bath heating detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
