...
public abstract class EmergencyButton extends DeviceObject {
	...
	private static final String TAG = EmergencyButton.class.getSimpleName();
	...
	/**
	 * This property indicates emergency occurrence status.<br>Emergency occurrence status found = 0x41 Emergency occurrence status not found = 0x42
	 */
	protected abstract byte[] getEmergencyOccurrenceStatus();
	/**
	 * Resets emergency occurrence status by setting 0x00.<br>Reset = 0x00
	 */
