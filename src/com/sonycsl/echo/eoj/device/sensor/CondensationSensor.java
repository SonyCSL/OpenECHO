...
public abstract class CondensationSensor extends DeviceObject {
	...
	private static final String TAG = CondensationSensor.class.getSimpleName();
	...
	/**
	 * This property indicates condensation detection    status.<br>Condensation detection status    found = 0x41 Condensation detection status   not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
	 */
