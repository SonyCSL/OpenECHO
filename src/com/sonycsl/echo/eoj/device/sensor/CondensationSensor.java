...
public abstract class CondensationSensor extends DeviceObject {
	...
	protected static final byte EPC_CONDENSATION_DETECTION_STATUS = (byte)0xB1;
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_CONDENSATION_DETECTION_STATUS:
			edt = getCondensationDetectionStatus();
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_CONDENSATION_DETECTION_STATUS:
				onGetCondensationDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates condensation detection    status.<br>Condensation detection status    found = 0x41 Condensation detection status   not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetCondensationDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetCondensationDetectionStatus() {
			...
			addProperty(EPC_CONDENSATION_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
