...
public abstract class CondensationSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x0A;
	...
	/**
	 * This property indicates condensation detection    status.<br><br>Condensation detection status    found = 0x41 Condensation detection status   not found = 0x42<br><br>Name : Condensation detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getCondensationDetectionStatus();
	private final byte[] _getCondensationDetectionStatus(byte epc) {
		byte[] edt = getCondensationDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_CONDENSATION_DETECTION_STATUS:
			edt = _getCondensationDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_CONDENSATION_DETECTION_STATUS:
				_onGetCondensationDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates condensation detection    status.<br><br>Condensation detection status    found = 0x41 Condensation detection status   not found = 0x42<br><br>Name : Condensation detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetCondensationDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetCondensationDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetCondensationDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetCondensationDetectionStatus() {
			addProperty(EPC_CONDENSATION_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformCondensationDetectionStatus() {
			byte epc = EPC_CONDENSATION_DETECTION_STATUS;
			byte[] edt = _getCondensationDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
