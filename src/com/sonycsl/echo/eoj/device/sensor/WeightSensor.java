...
public abstract class WeightSensor extends DeviceObject {
	...
	private static final String TAG = WeightSensor.class.getSimpleName();
	...
	/**
	 * This property indicates weight detection status.<br>Weight detection status found = 0x41 Weight detection status not found = 0x42
	 */
