...
public abstract class WeightSensor extends DeviceObject {
	...
	/**
	 * This property indicates weight detection status.<br><br>Weight detection status found = 0x41 Weight detection status not found = 0x42<br><br>Name : Weight detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetWeightDetectionStatus() {
			addProperty(EPC_WEIGHT_DETECTION_STATUS);
			return this;
		}
	}
