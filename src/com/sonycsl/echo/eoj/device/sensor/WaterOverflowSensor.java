...
public abstract class WaterOverflowSensor extends DeviceObject {
	...
	/**
	 * This property indicates water overflow status.<br><br>Water overflow detection status found = 0x41 Water overflow detection status not found = 0x42<br><br>Name : Water overflow detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getWaterOverflowDetectionStatus();
	private final byte[] _getWaterOverflowDetectionStatus(byte epc) {
		byte[] edt = getWaterOverflowDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_WATER_OVERFLOW_DETECTION_STATUS:
			edt = _getWaterOverflowDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_WATER_OVERFLOW_DETECTION_STATUS:
				_onGetWaterOverflowDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates water overflow status.<br><br>Water overflow detection status found = 0x41 Water overflow detection status not found = 0x42<br><br>Name : Water overflow detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetWaterOverflowDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetWaterOverflowDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetWaterOverflowDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetWaterOverflowDetectionStatus() {
			addProperty(EPC_WATER_OVERFLOW_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformWaterOverflowDetectionStatus() {
			byte epc = EPC_WATER_OVERFLOW_DETECTION_STATUS;
			byte[] edt = _getWaterOverflowDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
