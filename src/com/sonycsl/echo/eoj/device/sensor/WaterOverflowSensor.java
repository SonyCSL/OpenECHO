...
public abstract class WaterOverflowSensor extends DeviceObject {
	...
	protected static final byte EPC_WATER_OVERFLOW_DETECTION_STATUS = (byte)0xB1;
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_WATER_OVERFLOW_DETECTION_STATUS:
			edt = getWaterOverflowDetectionStatus();
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_WATER_OVERFLOW_DETECTION_STATUS:
				onGetWaterOverflowDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates water overflow status.<br>Water overflow detection status found = 0x41 Water overflow detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetWaterOverflowDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetWaterOverflowDetectionStatus() {
			...
			addProperty(EPC_WATER_OVERFLOW_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
