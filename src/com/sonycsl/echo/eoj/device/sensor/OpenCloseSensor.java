...
public abstract class OpenCloseSensor extends DeviceObject {
	...
	private static final String TAG = OpenCloseSensor.class.getSimpleName();
	...
	/**
	 * Specifies open/close detection status and one of 8 different degrees of opening.<br>Close detected: 0x30; Degree-of-opening level: 0x31 to 0x38; Open detected but degree-of-opening unknown: 0x39
	 */
	...
	/**
	 * Specifies whether degree-of .opening detected or not<br>Degree-of-opening detection detected =0x41, not detected =0x42
	 */
