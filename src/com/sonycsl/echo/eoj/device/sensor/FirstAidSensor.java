...
public abstract class FirstAidSensor extends DeviceObject {
	...
	/**
	 * This property indicates first-aid occurrence status.<br>First-air occurrence status found = 0x41 First-aid occurrence status not found = 0x42
	 */
	protected abstract byte[] getFirstAidOccurrenceStatus();
	/**
	 * Resets first-aid occurrence status by setting 0x00.<br>Reset = 0x00
	 */
