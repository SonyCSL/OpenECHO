...
public abstract class VOCSensor extends DeviceObject {
	...
	private static final String TAG = VOCSensor.class.getSimpleName();
	...
	/**
	 * This property indicates VOC detection status.<br>VOC detection status found = 0x41 VOC detection status not found = 0x42
	 */
	protected byte[] getVocDetectionStatus() {return null;}
	/**
	 * This property indicates measured value of VOC concentration in ppm.<br>0x0000.0xFFFD (0.65533)
	 */
