...
public abstract class VOCSensor extends DeviceObject {
	...
	/**
	 * This property indicates VOC detection status.<br><br>VOC detection status found = 0x41 VOC detection status not found = 0x42<br><br>Name : VOC detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : optional<br><br>Announcement at status change<br>
	 */
	...
	/**
	 * This property indicates measured value of VOC concentration in ppm.<br><br>0x0000.0xFFFD (0.65533)<br><br>Name : Measured value of VOC concentration<br>EPC : 0xE0<br>Data Type : unsigned short<br>Data Size(Byte) : 2 bytes<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br>
	 */
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetVocDetectionStatus() {
			addProperty(EPC_VOC_DETECTION_STATUS);
			return this;
		}
		/**
		 * This property indicates measured value of VOC concentration in ppm.<br><br>0x0000.0xFFFD (0.65533)<br><br>Name : Measured value of VOC concentration<br>EPC : 0xE0<br>Data Type : unsigned short<br>Data Size(Byte) : 2 bytes<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br>
		...
		public Getter reqGetMeasuredValueOfVocConcentration() {
			addProperty(EPC_MEASURED_VALUE_OF_VOC_CONCENTRATION);
			return this;
		}
	}
