...
public abstract class GasLeakSensor extends DeviceObject {
	...
	/**
	 * Specifies detection threshold level in 8 steps.<br>0x31.0x38
	 */
	...
	/**
	 * This property indicates gas leak occurrence status.<br>Gas leak occurrence status found = 0x41 Gas leak occurrence status not found = 0x42
	 */
	protected abstract byte[] getGasLeakOccurrenceStatus();
	/**
	 * Resets gas leak occurrence status by setting 0x00.<br>Reset = 0x00
	 */
