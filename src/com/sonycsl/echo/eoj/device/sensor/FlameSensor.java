...
public abstract class FlameSensor extends DeviceObject {
	...
	/**
	 * This property indicates flame detection status.<br><br>Flame detection status found = 0x41 Flame detection status not found = 0x42<br><br>Name : Flame detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	...
	/**
	 * Resets flame detection status by setting 0x00.<br><br>Reset = 0x00<br><br>Name : Flame detection status resetting<br>EPC : 0xBF<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : optional<br>Get : undefined<br>
	 */
	...
	public class Setter extends DeviceObject.Setter {
		...
		public Setter reqSetFlameDetectionStatusResetting(byte[] edt) {
			addProperty(EPC_FLAME_DETECTION_STATUS_RESETTING, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetFlameDetectionStatus() {
			addProperty(EPC_FLAME_DETECTION_STATUS);
			return this;
		}
	}
