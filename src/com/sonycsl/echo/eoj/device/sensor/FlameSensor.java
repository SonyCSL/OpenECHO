...
public abstract class FlameSensor extends DeviceObject {
	...
	private static final String TAG = FlameSensor.class.getSimpleName();
	...
	/**
	 * This property indicates flame detection status.<br>Flame detection status found = 0x41 Flame detection status not found = 0x42
	 */
	protected abstract byte[] getFlameDetectionStatus();
	/**
	 * Resets flame detection status by setting 0x00.<br>Reset = 0x00
	 */
