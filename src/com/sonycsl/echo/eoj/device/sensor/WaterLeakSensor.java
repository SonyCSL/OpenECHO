...
public abstract class WaterLeakSensor extends DeviceObject {
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_WATER_LEAK_DETECTION_STATUS:
			edt = getWaterLeakDetectionStatus();
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte epc,
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_WATER_LEAK_DETECTION_STATUS:
				onGetWaterLeakDetectionStatus(eoj, tid, pdc, edt);
				break;
		 ...
		 * This property indicates water leak detection status<br>Water leak detection status found = 0x41 Water leak detection status not found = 0x42<br><br>Data type : unsigned char<br>Data size : 1 byte<br>Set : undefined<br>Get : mandatory<br>Announcement at status change
		 */
		protected void onGetWaterLeakDetectionStatus(EchoObject eoj, short tid, byte pdc, byte[] edt) {}
	...
	public class GetterImpl extends DeviceObject.GetterImpl implements Getter {
		...
		public Getter reqGetWaterLeakDetectionStatus() {
			...
			addProperty(EPC_WATER_LEAK_DETECTION_STATUS, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
