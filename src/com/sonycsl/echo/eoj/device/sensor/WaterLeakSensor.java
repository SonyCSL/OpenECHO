...
public abstract class WaterLeakSensor extends DeviceObject {
	...
	public static final byte CLASS_CODE = (byte)0x17;
	...
	/**
	 * This property indicates water leak detection status<br><br>Water leak detection status found = 0x41 Water leak detection status not found = 0x42<br><br>Name : Water leak detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
	 */
	protected abstract byte[] getWaterLeakDetectionStatus();
	private final byte[] _getWaterLeakDetectionStatus(byte epc) {
		byte[] edt = getWaterLeakDetectionStatus();
		onInvokedGetMethod(epc, edt);
		return edt;
	}
	...
	protected void onReceiveGet(EchoFrame res, byte epc) {
		...
		case EPC_WATER_LEAK_DETECTION_STATUS:
			edt = _getWaterLeakDetectionStatus(epc);
			res.addProperty(epc, edt, (edt != null && (edt.length == 1)));
			break;
	...
	public static class Receiver extends DeviceObject.Receiver {
		...
		protected void onReceiveGetRes(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			...
			case EPC_DETECTION_THRESHOLD_LEVEL:
				...
				break;
			case EPC_WATER_LEAK_DETECTION_STATUS:
				_onGetWaterLeakDetectionStatus(eoj, tid, esv, epc, pdc, edt);
				break;
		 ...
		 * This property indicates water leak detection status<br><br>Water leak detection status found = 0x41 Water leak detection status not found = 0x42<br><br>Name : Water leak detection status<br>EPC : 0xB1<br>Data Type : unsigned char<br>Data Size(Byte) : 1 byte<br><br>AccessRule<br>Announce : undefined<br>Set : undefined<br>Get : mandatory<br><br>Announcement at status change<br>
		 */
		protected void onGetWaterLeakDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {}
		private final void _onGetWaterLeakDetectionStatus(EchoObject eoj, short tid, byte esv, byte epc, byte pdc, byte[] edt) {
			onGetWaterLeakDetectionStatus(eoj, tid, esv, epc, pdc, edt);
			onInvokedOnGetMethod(eoj, tid, esv, epc, pdc, edt);
		}
	...
	public class Getter extends DeviceObject.Getter {
		...
		public Getter reqGetWaterLeakDetectionStatus() {
			addProperty(EPC_WATER_LEAK_DETECTION_STATUS);
			return this;
		}
	}
	...
	public class InformerImpl extends DeviceObject.InformerImpl implements Informer {
		...
		@Override
		public Informer reqInformWaterLeakDetectionStatus() {
			byte epc = EPC_WATER_LEAK_DETECTION_STATUS;
			byte[] edt = _getWaterLeakDetectionStatus(epc);
			addProperty(epc, edt, (edt != null && (edt.length == 1)));
			return this;
		}
	}
