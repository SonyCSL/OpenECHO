...
public class CurrentValueSensorProxy extends CurrentValueSensor {
	@SuppressWarnings("unused")
	private static final String TAG = CurrentValueSensorProxy.class.getSimpleName();

	private byte mInstanceCode;
	
	public CurrentValueSensorProxy(byte instanceCode) {
	...
	public static class Receiver extends CurrentValueSensor.Receiver {
	}
}
