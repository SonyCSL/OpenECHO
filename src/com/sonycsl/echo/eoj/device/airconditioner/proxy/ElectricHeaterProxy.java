...
public class ElectricHeaterProxy extends ElectricHeater {
	@SuppressWarnings("unused")
	private static final String TAG = ElectricHeaterProxy.class.getSimpleName();

	private byte mInstanceCode;
	
	public ElectricHeaterProxy(byte instanceCode) {
	...
	public static class Receiver extends ElectricHeater.Receiver {
	}
}
