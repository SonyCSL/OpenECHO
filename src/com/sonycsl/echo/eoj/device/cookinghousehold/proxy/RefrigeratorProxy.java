...
public class RefrigeratorProxy extends Refrigerator {
	@SuppressWarnings("unused")
	private static final String TAG = RefrigeratorProxy.class.getSimpleName();
	...
	public static class Receiver extends Refrigerator.Receiver {
	}
}
