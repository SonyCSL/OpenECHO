...
public abstract class Weighing extends DeviceObject {
	...
	private static final String TAG = Weighing.class.getSimpleName();
	...
	/**
	 * This property indicates measured value of body weight in units of 0.1 kg.<br>0x0000.0xFFFD (0.6553.3kg)
	 */
	protected abstract byte[] getMeasuredValueOfBodyWeight();
	/**
	 * This property indicates measured value of body fat in units of 0.1%.<br>0x0000.0x03E8 (0.100.0%)
	 */
