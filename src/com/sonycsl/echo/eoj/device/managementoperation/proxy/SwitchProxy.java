 ...
 */
package com.sonycsl.echo.eoj.device.managementoperation.proxy;

import com.sonycsl.echo.eoj.device.managementoperation.Switch;

public class SwitchProxy extends Switch {
	@SuppressWarnings("unused")
	private static final String TAG = SwitchProxy.class.getSimpleName();
